...
export default function Sidebar() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: async () => {
      const adminRequests = await axios.get(process.env.NEXT_PUBLIC_BASE_URL + `/admin/pendingadmins/${page}/${itemsPerPage}`);
      console.log(adminRequests.data.items, "admin list for pending count");
      setRequests(adminRequests.data.items);
  ...
  //     if (isSuperAdmin) {
  //       console.log("Fetching pending admin count for super admin");
  //       // const admins = JSON.parse(localStorage.getItem('admins') || '[]');
  //       const adminRequests = await axios.get(process.env.NEXT_PUBLIC_BASE_URL + `/admin/pendingadmins/${page}/${itemsPerPage}`);
  //       console.log(adminRequests.data.items, "admin list for pending count");
  //       setRequests(adminRequests.data.data.items);
  //       // const pendingAdmins = admins.filter(admin => !admin.approved && !admin.rejected);
  //       setPendingCount(adminRequests.length);
  //     }
  //   };
