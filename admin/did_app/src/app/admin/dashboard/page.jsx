...
export default function DashboardContent() {
  ...
  useEffect(() => {
    ...
    console.log(rawData, 'multiplex111');
            ...
            <div className=" rounded-2xl shadow-sm border bg-darkergray text-textIcons border-gray-200 p-6">
              ...
              <div className="w-[1000px] rounded-2xl " >
                ...
                <div className="p-6 bg-darkergray rounded-xl shadow-md">
                  <h2 className="text-lg font-semibold mb-4">수료증 발급 현황</h2>
                  <ReactECharts option={option} style={{ height: 300 }} />
                </div>
              </div>
              <div className=" h-[300px] md:h-[400px]  rounded-2xl">
            ...
            <div className="bg-darkergray rounded-2xl min-h-200 shadow-sm border border-gray-200">
              <div className="p-6">
                ...
                <div className="mb-8">
                  <div className="relative ">
                    ...
                    {searchQuery && (
                      ...
                      >
                        <svg className="h-5 w-5  hover:" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-3  flex justify-around">
                  ...
                  <div>
                    <div className="flex flex-wrap gap-2 items-center">
                      <h4 className="font-medium  ">기간별 필터 : </h4>
                      <button
                ...
                <div className="  min-h-150 p-6 flex flex-col justify-between rounded-lg shadow overflow-hidden">
                  <div>
                    <div className="space-y-3 p-4 md:p-6">
                      {/* 헤더 - 데스크톱에서만 표시 */}
                      <div className=" md:grid grid-cols-[80px_120px_120px_120px_120px_1fr_120px_120px_150px] text-center gap-4 px-6 py-3 bg-gray-50 rounded-lg  font-medium text-textIcons uppercase tracking-wider">
                        <div>번호</div>
                        <div>이름</div>
                        <div>사용자 ID</div>
                        <div>요청 유형</div>
                        ...
                        <div key={request._id || (startIndex + index)} className="bg-white border  border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                          ...
                          <div className="  text-center md:grid grid-cols-[80px_120px_120px_120px_120px_1fr_120px_120px_150px] gap-4 items-center">
                            ...
                            <div className="flex items-center  gap-2">
                              <img className="w-9 h-9 rounded-full object-cover" src={request.ImagePath || '/images/default-avatar.png'} alt="" />
                            ...
                            <div>
                              <span className={`inline-flex px-4 py-2 text-sm text-whiteback font-medium rounded ${request.request === 'issue'
                                ...
                                {request.request === 'issue' ? '발급 요청'
                                  : request.request === 'revoke' ? '폐기 요청'
                                    : '발급 완료'}
                              </span>
                            </div>
